...
export default class Game {
  ...
  createRandomBlock () {
    const randomNumber = Math.floor(Math.random() * constants.TETRIS_BLOCK_CHARACTERS.length)
    const blockLetter = constants.TETRIS_BLOCK_CHARACTERS.charAt(randomNumber)
